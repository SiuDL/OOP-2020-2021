...
public class Arrays extends PApplet {
    ...
    public float map1(float from, float start1, float stop1, float start2, float stop2){
        ...
        //return start2 + (stop2 - start2) * ((from - start1) / (stop1 - start1));
    }
    ...
    float[] rainfall = {45, 37, 55, 27, 38, 50, 79, 48, 105, 31, 100, 58};
    ...
    public void setup() {
        ...
        println("Least rainfall was in "+ months[min] + " with " + rainfall[min]);
        println("Most rainfall was in "+ months[max] + " with " + rainfall[max]);
        println("Average ranfall: " + average);
